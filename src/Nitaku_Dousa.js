...
var $author$project$Nitaku_Dousa$Model = F4(
...
var $author$project$Nitaku_Dousa$init = function (_v0) {
	return _Utils_Tuple2($author$project$Nitaku_Dousa$minit, $elm$core$Platform$Cmd$none);
};
...
var $author$project$Nitaku_Dousa$shutudaiL = _List_fromArray(
	[
		{
		img: 'tatu',
		...
		{
		img: 'neru',
		obj: {img1: 'neru', img2: 'osu', mondai: 'ねる'}
	},
		{
		img: 'osu',
		obj: {img1: 'kiru', img2: 'osu', mondai: 'おす'}
	},
		{
		img: 'kiru',
		obj: {img1: 'hakobu', img2: 'kiru', mondai: 'きる'}
	},
		{
		img: 'hakobu',
		obj: {img1: 'hakobu', img2: 'motu', mondai: 'はこぶ'}
	},
		{
		img: 'motu',
		obj: {img1: 'motu', img2: 'keru', mondai: 'もつ'}
	},
		{
		img: 'shagamu',
		obj: {img1: 'shagamu', img2: 'korobu', mondai: 'しゃがむ'}
	},
		{
		img: 'keru',
		obj: {img1: 'kaku', img2: 'keru', mondai: 'ける'}
	},
		{
		img: 'kaku',
		obj: {img1: 'aruku', img2: 'kaku', mondai: 'かく'}
	},
		{
		img: 'korobu',
		obj: {img1: 'korobu', img2: 'yaburu', mondai: 'ころぶ'}
	},
		{
		img: 'aruku',
		obj: {img1: 'aruku', img2: 'oru', mondai: 'あるく'}
	},
		{
		img: 'yaburu',
		obj: {img1: 'kiru', img2: 'yaburu', mondai: 'やぶる'}
	},
		{
		img: 'oru',
...
var $author$project$Nitaku_Dousa$shutudai = function (num) {
	var ltail = A2($elm$core$List$drop, num, $author$project$Nitaku_Dousa$shutudaiL);
...
var $author$project$Nitaku_Dousa$speak = _Platform_outgoingPort('speak', $elm$json$Json$Encode$string);
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Nitaku_Dousa$startSound = _Platform_outgoingPort(
	'startSound',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Nitaku_Dousa$startSound2 = _Platform_outgoingPort(
	'startSound2',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
...
var $author$project$Nitaku_Dousa$fsearch = F2(
	function (ig, obj) {
		return _Utils_eq(obj.img, ig);
	});
var $author$project$Nitaku_Dousa$zenkaku = function (hk) {
	var lfilter = A2(
		$elm$core$List$filter,
		$author$project$Nitaku_Dousa$fsearch(hk),
		$author$project$Nitaku_Dousa$shutudaiL);
...
var $author$project$Nitaku_Dousa$update = F2(
	function (msg, model) {
		var sflg2 = _Utils_eq(
			model.toi.mondai,
			$author$project$Nitaku_Dousa$zenkaku(model.toi.img2)) ? true : false;
		var sflg1 = _Utils_eq(
			model.toi.mondai,
			$author$project$Nitaku_Dousa$zenkaku(model.toi.img1)) ? true : false;
		switch (msg.$) {
			case 'Inc':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							num: (_Utils_cmp(
								model.num,
								$elm$core$List$length($author$project$Nitaku_Dousa$shutudaiL) - 1) < 0) ? (model.num + 1) : 1,
							toi: $author$project$Nitaku_Dousa$shutudai(model.num)
						}),
					$author$project$Nitaku_Dousa$speak(
						$author$project$Nitaku_Dousa$shutudai(model.num).mondai + 'は、どれかな'));
			case 'Btn1':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							num: sflg1 ? ((_Utils_cmp(
								model.num,
								$elm$core$List$length($author$project$Nitaku_Dousa$shutudaiL) - 1) < 0) ? (model.num + 1) : 1) : model.num,
							seikaiflg: sflg1,
							toi: sflg1 ? $author$project$Nitaku_Dousa$shutudai(model.num) : model.toi
						}),
					sflg1 ? $author$project$Nitaku_Dousa$startSound(_Utils_Tuple0) : $author$project$Nitaku_Dousa$startSound2(_Utils_Tuple0));
			case 'Btn2':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							num: sflg2 ? ((_Utils_cmp(
								...
								$elm$core$List$length($author$project$Nitaku_Dousa$shutudaiL) - 1) < 0) ? (model.num + 1) : 1) : model.num,
							seikaiflg: sflg2,
							toi: sflg2 ? $author$project$Nitaku_Dousa$shutudai(model.num) : model.toi
						}),
					sflg2 ? $author$project$Nitaku_Dousa$startSound(_Utils_Tuple0) : $author$project$Nitaku_Dousa$startSound2(_Utils_Tuple0));
			case 'BtnMondai':
				return _Utils_Tuple2(
					model,
					$author$project$Nitaku_Dousa$speak(
						$author$project$Nitaku_Dousa$shutudai(model.num - 1).mondai + 'わ、どれ？'));
			case 'StartSound':
				return _Utils_Tuple2(
					model,
					$author$project$Nitaku_Dousa$startSound(_Utils_Tuple0));
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Nitaku_Dousa$startSound2(_Utils_Tuple0));
		}
	});
var $author$project$Nitaku_Dousa$Btn1 = {$: 'Btn1'};
var $author$project$Nitaku_Dousa$Btn2 = {$: 'Btn2'};
var $author$project$Nitaku_Dousa$BtnMondai = {$: 'BtnMondai'};
var $author$project$Nitaku_Dousa$Inc = {$: 'Inc'};
...
var $author$project$Nitaku_Dousa$view = function (model) {
	var marubatu = A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Nitaku_Dousa$BtnMondai)
					]))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(model.toi.mondai)
			]));
	var btn2 = A2(
		$rundis$elm_bootstrap$Bootstrap$Button$button,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$m1,
						$elm$html$Html$Events$onClick($author$project$Nitaku_Dousa$Inc)
					]))
			]),
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Nitaku_Dousa$Btn1),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Nitaku_Dousa$Btn2),
										A2($elm$html$Html$Attributes$style, 'width', '25vw')
									]),
								_List_Nil)
							]))
...
var $author$project$Nitaku_Dousa$main = $elm$browser$Browser$element(
	{
		init: $author$project$Nitaku_Dousa$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Nitaku_Dousa$update,
		view: $author$project$Nitaku_Dousa$view
	});
_Platform_export({'Nitaku_Dousa':{'init':$author$project$Nitaku_Dousa$main(
