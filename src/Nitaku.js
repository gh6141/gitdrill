...
var $author$project$Nitaku$shutudai = function (num) {
	switch (num) {
		...
		case 9:
			return {img1: 'pull.gif', img2: 'run.gif', mondai: 'ひっぱる'};
		case 10:
			return {img1: 'great.gif', img2: 'carry.gif', mondai: 'はこぶ'};
		case 11:
			return {img1: 'worry.gif', img2: 'kowai.gif', mondai: 'こわい'};
		case 12:
			return {img1: 'iraira.gif', img2: 'walk.gif', mondai: 'いらいら'};
		case 13:
			return {img1: 'run.gif', img2: 'walk.gif', mondai: 'あるく'};
		case 14:
			return {img1: 'iraira.gif', img2: 'worry.gif', mondai: 'しんぱい'};
		case 15:
			return {img1: 'great.gif', img2: 'carry.gif', mondai: 'すごい'};
		case 16:
			return {img1: 'pull.gif', img2: 'run.gif', mondai: 'はしる'};
		default:
...
var $author$project$Nitaku$startSound2 = _Platform_outgoingPort(
	'startSound2',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
		...
		switch (msg.$) {
			...
			case 'Btn1':
				return _Utils_Tuple2(
					...
					sflg1 ? $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
			...
			case 'Btn2':
				return _Utils_Tuple2(
					...
					sflg2 ? $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Nitaku$startSound(_Utils_Tuple0),
								$author$project$Nitaku$speak(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Nitaku$BtnMondai)
					]))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$m1,
						$elm$html$Html$Events$onClick($author$project$Nitaku$Inc)
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Nitaku$main = $elm$browser$Browser$element(
	{
		init: $author$project$Nitaku$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Nitaku$update,
		view: $author$project$Nitaku$view
	});
_Platform_export({'Nitaku':{'init':$author$project$Nitaku$main(
