		...
		switch (msg.$) {
			...
			case 'Btn1':
				return _Utils_Tuple2(
					...
					sflg1 ? $author$project$Nitaku$startSound(_Utils_Tuple0) : $author$project$Nitaku$startSound2(_Utils_Tuple0));
			case 'Btn2':
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					sflg2 ? $author$project$Nitaku$startSound(_Utils_Tuple0) : $author$project$Nitaku$startSound2(_Utils_Tuple0));
			case 'BtnMondai':
				return _Utils_Tuple2(
					model,
					$author$project$Nitaku$speak(
						$author$project$Nitaku$shutudai(model.num - 1).mondai + 'わ、どれ？'));
			case 'StartSound':
				return _Utils_Tuple2(
					model,
