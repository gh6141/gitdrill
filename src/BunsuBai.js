			...
			function (i1, i2, i3, i4) {
				return {
					...
					seikai: function () {
						...
						var kaisi = _n4.a;
						var kaibo = _n4.b;
						return author$project$BunsuBai$yakubun(
							{
								bunbo: kaibo,
								bunsi: kaisi,
								enzan: author$project$BunsuBai$Sento,
...
var author$project$BunsuBai$ysCreate = function (ax) {
	...
	if (A2(elm$core$String$contains, '分の', ax)) {
		...
		return {
			bunbo: author$project$BunsuBai$toint(bbot),
		...
		var func = F2(
			function (yu, yuacl) {
				var test = A2(
					elm$core$Debug$log,
					'bo bs=',
					elm$core$String$fromInt(yu.bunsi) + ('/' + elm$core$String$fromInt(yu.bunbo)));
...
var author$project$BunsuBai$yuriCheckSiki = function (ans) {
...
var author$project$BunsuBai$viewCreateSiki = function (ans) {
	var ml = A2(
		elm$core$List$map,
		function (siki) {
			return A2(
				...
				_List_fromArray(
					[
						author$project$BunsuBai$spankatex(siki)
					]));
		},
		author$project$BunsuBai$yuriCheckSiki(ans));
	return ml;
};
				...
				return author$project$BunsuBai$divkatex(
					_List_fromArray(
						[
							...
							yotamDvir$elm_katex$Katex$inline(model.bun2),
							yotamDvir$elm_katex$Katex$human('mです。赤リボンは何m?')
						]));
			case 3:
				return author$project$BunsuBai$divkatex(
					_List_fromArray(
						[
							...
							yotamDvir$elm_katex$Katex$inline(model.bun2),
							yotamDvir$elm_katex$Katex$human('倍です。青リボンの長さは?')
						]));
			default:
				return author$project$BunsuBai$divkatex(
					_List_fromArray(
