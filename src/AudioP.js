...
var $author$project$AudioP$subscriptions = function (_v0) {
...
var $author$project$AudioP$shutudai = F2(
	function (num, model) {
		if (num === 100) {
			...
			var mondl = model.mdl;
			var _v1 = A2($author$project$AudioP$getAt, num, mondl);
			if (_v1.$ === 'Just') {
				var mond = _v1.a;
				return _Utils_update(
					model,
					{
						...
						ansn: function () {
							var _v2 = $elm$core$String$toInt(mond.ansn);
							if (_v2.$ === 'Just') {
								var ani = _v2.a;
								return ani - 1;
							} else {
