...
data= [("Na","ナトリウム原子"),("H","水素原子"),("O","酸素原子"),("Cl","塩素原子"),("S","硫黄原子"),("Fe","鉄原子"),("Al","アルミニウム原子"),("Cu","銅原子"),("Zn","亜鉛原子"),("C","炭素原子"),("N","窒素原子"),("K","カリウム原子"),("Ca","カルシウム原子"),("Ba","バリウム原子"),("Ag","銀原子")]
...
view model =
  div []
    ...
    , div [Html.Attributes.style "font-size" "100pt"] [text model.name]
    --, div [Html.Attributes.style "font-size" "80pt"] [text model.siki]
    , button [ Html.Attributes.style "margin" "5pt",Html.Attributes.style "font-size" "40pt",onClick B1 ] [ text (Maybe.withDefault "" (getAt 0 model.sikil)) ]
    , button [ Html.Attributes.style "margin" "5pt",Html.Attributes.style "font-size" "40pt",onClick B2 ] [ text (Maybe.withDefault "" (getAt 1 model.sikil)) ]
    , button [ Html.Attributes.style "margin" "5pt",Html.Attributes.style "font-size" "40pt",onClick B3 ] [ text (Maybe.withDefault "" (getAt 2 model.sikil)) ]
