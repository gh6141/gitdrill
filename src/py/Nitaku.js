...
var author$project$Nitaku$Model = function (flist) {
	return {flist: flist};
};
...
var author$project$Nitaku$minit = author$project$Nitaku$Model(
	_List_fromArray(
		['', '', '']));
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$m1,
						elm$html$Html$Events$onClick(author$project$Nitaku$Dec)
					]))
			]),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$src('py/car1.jpg')
									]),
								_List_Nil)
							])),
						A2(
